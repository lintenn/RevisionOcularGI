"""
Django settings for RevisionOcular project.
...
SECRET_KEY = 'django-insecure-2x^ck823=#2f8p3zl)4ifcln-+uoq2ayz#yfv$@(l!uo#9#98!'
...
ROOT_URLCONF = 'RevisionOcular.urls'
...
WSGI_APPLICATION = 'RevisionOcular.wsgi.application'
